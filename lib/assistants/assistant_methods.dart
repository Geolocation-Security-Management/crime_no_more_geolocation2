import 'package:crime_no_more_geolocation2/assistants/request_assistant.dart';
import 'package:crime_no_more_geolocation2/global/global.dart';
import 'package:crime_no_more_geolocation2/models/direction_details_info.dart';
import 'package:crime_no_more_geolocation2/models/directions.dart';
  ...
  static Future<String> searchAddressForGeographicCoOrdinates(
    ...
    if (requestResponse != "Error Occurred, Failed. No Response.") {
      humanReadableAddress =
          await requestResponse["results"][0]["formatted_address"];
